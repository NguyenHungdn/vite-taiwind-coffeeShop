function MagazineCoffee() {
   return (
      <div className="coffee-magazine w-[99%] xl:w-[65%] mx-auto md:mb-24 mb-16">
         <div className="  flex md:flex-row  md:gap-5 flex-col md:order-1 order-2  ">
            ...
            <div className="  md:basis-1/2 flex   md:order-2 order-1  ">
               <div className="ata-magazine w-full h-[430px] md:h-[280px]  flex lg:gap-5 gap-2 md:flex-row flex-col ">
                  ...
                  <div className="ata-magazine-small-image flex  md:flex-col md:gap-2 lg:gap-5 gap-2 basis-1/2   ">
                     <div className="ata-magazine-small-image01 h-[130px] xs:h-[200px] md:h-[130px] flex-1  bg-[url('./assets/magazine/image1.jpg')] bg-no-repeat bg-center bg-cover"></div>
                     <div className="ata-magazine-small-image02 h-[130px] xs:h-[200px] md:h-[130px] flex-1  bg-[url('./assets/magazine/image2.jpg')] bg-no-repeat bg-center bg-cover"></div>
                  </div>
               </div>
            </div>
         </div>
